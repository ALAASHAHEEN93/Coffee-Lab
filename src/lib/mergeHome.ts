...
export function mergeHome(h: Home | null, locale: 'de' | 'en' = 'en'): Home {
  ...
  return {
    ...
    operationsPhase: x.operationsPhase ?? d.operationsPhase,
    operationsTitle: x.operationsTitle ?? d.operationsTitle,
    operationsIntro: x.operationsIntro ?? d.operationsIntro,
    operationsPanels: x.operationsPanels?.length ? x.operationsPanels : d.operationsPanels,
